...
# simple analysis we need to jump to babymode()
# theres also a buffer overflow, but the stack is
...
base = fib(290)
canary = fib(289)
# the return address is some address main()
...
# to the code in babymode() after the function prologue
babymode = ret-482+4
